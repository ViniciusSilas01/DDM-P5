...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: '#fff', justifyContent: 'flex-start', alignItems: 'center', padding: 24, paddingTop: 60 },
    content: { width: '100%', alignItems: 'center' },
    logo: { width: 160, height: 160, marginBottom: 16 },
    title: { fontSize: 26, fontWeight: 'bold', marginBottom: 24 },
    input: { width: '100%', borderBottomWidth: 1, marginBottom: 20, paddingVertical: 14, fontSize: 16 },
    ...
    socialButtons: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 16, width: '100%', borderRadius: 5, marginVertical: 5, justifyContent: 'center' },
    socialText: { flex: 1, color: '#fff', fontSize: 16, fontWeight: 'bold', textAlign: 'center' },
